...
#escape velocity
#start_dy_esc = 3844000.0 / unit_in_km # 40000 km/h to unit
#start_dy_esc = 10.778
start_dy_esc = 10.8
#start_dx_esc = 20000.0 / unit_in_km
start_dx_esc = 0.0
#stable orbit
#start_dy_st = 2.0 / unit_in_km # 28000 km/h to unit
...
for i in range(max_bisections) :
    ...
    satellite = Satellite(start_x=start_x, start_dx=start_dx_esc, start_dy=mid_dy, mu=mu, mu_line=mu_line)
